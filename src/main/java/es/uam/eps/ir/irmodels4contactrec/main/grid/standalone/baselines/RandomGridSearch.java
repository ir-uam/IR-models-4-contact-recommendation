...
import es.uam.eps.ir.irmodels4contactrec.recommender.standalone.basic.Random;
...
import static es.uam.eps.ir.irmodels4contactrec.main.grid.AlgorithmIdentifiers.RANDOM;

/**
 * Grid search generator for Random algorithm.
 *
 * @see es.uam.eps.ir.irmodels4contactrec.recommender.standalone.basic.Random
 *
...
public class RandomGridSearch<U> implements AlgorithmGridSearch<U>
{
    ...
    public Map<String, RecommendationAlgorithmFunction<U>> grid(Grid grid)
    {
        ...
        RecommendationAlgorithmFunction<U> bifunction = (graph, prefdata) -> new Random<>(graph);
    ...
    public Map<String, Supplier<Recommender<U, U>>> grid(Grid grid, FastGraph<U> graph, FastPreferenceData<U, U> prefData)
    {
        ...
        recs.put(RANDOM, () -> new Random<>(graph));
        return recs;
    }
